...
typedef struct {
  ...
  __DECLARE_VAR(DINT,VAR1)
  __DECLARE_LOCATED(BOOL,S0)
  __DECLARE_LOCATED(BOOL,S1)
  __DECLARE_LOCATED(BOOL,S2)
  __DECLARE_LOCATED(BOOL,A0)
  __DECLARE_LOCATED(BOOL,A1)
  __DECLARE_LOCATED(BOOL,A2)
  __DECLARE_LOCATED(BOOL,A3)
  __DECLARE_LOCATED(BOOL,A4)
  __DECLARE_LOCATED(BOOL,A5)

...
typedef struct {
  ...
  __DECLARE_LOCATED(BOOL,SENSORROTRIGHTSAT3)
  __DECLARE_LOCATED(BOOL,SENSORROTLEFTSAT3)
  ...
  __DECLARE_LOCATED(BOOL,RIGHTROTSAT3)
  __DECLARE_LOCATED(BOOL,LEFTROTSAT3)

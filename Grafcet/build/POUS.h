...
typedef struct {
  ...
  __DECLARE_EXTERNAL(BOOL,SENDUPRIGHTMT6_EX)
  ...
  __DECLARE_EXTERNAL(BOOL,RECEIVEPIECEMT3_EX)
  ROTARYCONVEYOR SBT2;
  ...
  __DECLARE_EXTERNAL(BOOL,SENSORMT4_EX)
  ...
  __DECLARE_EXTERNAL(BOOL,RECEIVEPIECEMT4_EX)
  __DECLARE_EXTERNAL(BOOL,RUNFRONTMT4_EX)
  __DECLARE_EXTERNAL(BOOL,RUNFRONTMT3_EX)
  __DECLARE_EXTERNAL(BOOL,SENDDOWNSCT6_EX)
  __DECLARE_EXTERNAL(BOOL,SENDDOWNMT6_EX)
  __DECLARE_EXTERNAL(BOOL,SENSORMT3_EX)
...
typedef struct {
  ...
  STEP __step_list[60];
  UINT __nb_steps;
  ACTION __action_list[23];
  UINT __nb_actions;
  __IEC_BOOL_t __transition_list[58];
  __IEC_BOOL_t __debug_transition_list[58];
  UINT __nb_transitions;
  TIME __lasttick_time;

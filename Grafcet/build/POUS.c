...
void FACTORYFLOORPROGRAM_init__(FACTORYFLOORPROGRAM *data__, BOOL retain) {
  __INIT_EXTERNAL(BOOL,MOUNTING,data__->MOUNTING,retain)
...
void FACTORYFLOORPROGRAM_body__(FACTORYFLOORPROGRAM *data__) {
  ...
  __SET_VAR(data__->,OR434_OUT,,OR__BOOL__BOOL(
    ...
    (BOOL)__GET_EXTERNAL(data__->MOUNTING,)));
  ...
  __SET_VAR(data__->,OR210_OUT,,OR__BOOL__BOOL(
    ...
    (BOOL)__GET_LOCATED(data__->SENSORCT8,)));
...
void LOADPROGRAM_body__(LOADPROGRAM *data__) {
  ...
  if (__GET_VAR(data__->STEP84.X)) {
    __SET_VAR(data__->,__transition_list[8],,(__GET_EXTERNAL(data__->SENSORCT6_EX,) && !(__GET_EXTERNAL(data__->ISLOADINGP2,))));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[8],,__GET_VAR(data__->__transition_list[8]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[8],,(__GET_EXTERNAL(data__->SENSORCT6_EX,) && !(__GET_EXTERNAL(data__->ISLOADINGP2,))));
    }
    __SET_VAR(data__->,__transition_list[8],,0);
  }
  if (__GET_VAR(data__->STEP85.X)) {
...
#define STEP0 __step_list[56]
#define __SFC_STEP0 56
#define STEP58 __step_list[57]
#define __SFC_STEP58 57
#define STEP1 __step_list[58]
#define __SFC_STEP1 58
#define STEP57 __step_list[59]
#define __SFC_STEP57 59
#define STEP14 __step_list[60]
#define __SFC_STEP14 60
#define SENDTOP __step_list[61]
#define __SFC_SENDTOP 61
#define STEP28 __step_list[62]
#define __SFC_STEP28 62
#define STEP42 __step_list[63]
#define __SFC_STEP42 63
#define STEP41 __step_list[64]
#define __SFC_STEP41 64
#define STEP43 __step_list[65]
#define __SFC_STEP43 65
#define STEP45 __step_list[66]
#define __SFC_STEP45 66
#define STEP29 __step_list[67]
#define __SFC_STEP29 67
#define STEP31 __step_list[68]
#define __SFC_STEP31 68
#define STEP32 __step_list[69]
#define __SFC_STEP32 69
#define STEP33 __step_list[70]
#define __SFC_STEP33 70
#define STEP34 __step_list[71]
#define __SFC_STEP34 71
#define STEP35 __step_list[72]
#define __SFC_STEP35 72
#define STEP36 __step_list[73]
#define __SFC_STEP36 73
#define STEP37 __step_list[74]
#define __SFC_STEP37 74
#define STEP38 __step_list[75]
#define __SFC_STEP38 75
#define STEP40 __step_list[76]
#define __SFC_STEP40 76
#define STEP84 __step_list[77]
#define __SFC_STEP84 77
#define STEP85 __step_list[78]
#define __SFC_STEP85 78
#define STEP86 __step_list[79]
#define __SFC_STEP86 79
#define STEP87 __step_list[80]
#define __SFC_STEP87 80
#define STEP89 __step_list[81]
#define __SFC_STEP89 81
#define STEP90 __step_list[82]
#define __SFC_STEP90 82
#define STEP44 __step_list[83]
#define __SFC_STEP44 83
#define STEP83 __step_list[84]
#define __SFC_STEP83 84
...
#define __SFC_MOUNTING 19
#define __SFC_X1Y3_EX 20
#define __SFC_RUNFRONTMT4_EX 21
#define __SFC_SENDUPRIGHTMT6_EX 22
#define __SFC_RUNFRONTCT7_EX 23
#define __SFC_SENDRIGHTUPCT8_EX 24
#define __SFC_PUSHUPCT6_EX 25
...
void GANTRYPROGRAM_body__(GANTRYPROGRAM *data__) {
  ...
  if (__GET_VAR(data__->STEP53.X)) {
    __SET_VAR(data__->,__transition_list[19],,(__GET_EXTERNAL(data__->SENSORMT3_EX,) && !(__GET_EXTERNAL(data__->MOUNTING,))));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[19],,__GET_VAR(data__->__transition_list[19]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[19],,(__GET_EXTERNAL(data__->SENSORMT3_EX,) && !(__GET_EXTERNAL(data__->MOUNTING,))));
    }
    __SET_VAR(data__->,__transition_list[19],,0);
  }
  ...
  if (__GET_VAR(data__->STEP58.X)) {
    __SET_VAR(data__->,__transition_list[56],,__GET_EXTERNAL(data__->GANTRYBUSY_EX,));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[56],,__GET_VAR(data__->__transition_list[56]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[56],,__GET_EXTERNAL(data__->GANTRYBUSY_EX,));
    }
    __SET_VAR(data__->,__transition_list[56],,0);
  }
  if (__GET_VAR(data__->STEP1.X)) {
    __SET_VAR(data__->,__transition_list[57],,!(__GET_EXTERNAL(data__->GANTRYBUSY_EX,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[57],,__GET_VAR(data__->__transition_list[57]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[57],,!(__GET_EXTERNAL(data__->GANTRYBUSY_EX,)));
    }
    __SET_VAR(data__->,__transition_list[57],,0);
  }
  if (__GET_VAR(data__->STEP14.X)) {
  ...
  if (__GET_VAR(data__->STEP28.X)) {
    __SET_VAR(data__->,__transition_list[60],,!(__GET_EXTERNAL(data__->SENSORAT1_EX,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[60],,__GET_VAR(data__->__transition_list[60]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[60],,!(__GET_EXTERNAL(data__->SENSORAT1_EX,)));
    }
    __SET_VAR(data__->,__transition_list[60],,0);
  }
  if (__GET_VAR(data__->STEP42.X)) {
  ...
  if (__GET_VAR(data__->STEP41.X)) {
    __SET_VAR(data__->,__transition_list[62],,!(__GET_EXTERNAL(data__->SENSORSAT1_EX,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[62],,__GET_VAR(data__->__transition_list[62]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[62],,!(__GET_EXTERNAL(data__->SENSORSAT1_EX,)));
    }
    __SET_VAR(data__->,__transition_list[62],,0);
  }
  if (__GET_VAR(data__->STEP43.X)) {
  ...
  if (__GET_VAR(data__->STEP45.X)) {
    __SET_VAR(data__->,__transition_list[64],,!(__GET_EXTERNAL(data__->SENSORSAT2_EX,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[64],,__GET_VAR(data__->__transition_list[64]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[64],,!(__GET_EXTERNAL(data__->SENSORSAT2_EX,)));
    }
    __SET_VAR(data__->,__transition_list[64],,0);
  }
  if (__GET_VAR(data__->STEP29.X)) {
  ...
  if (__GET_VAR(data__->STEP31.X)) {
    __SET_VAR(data__->,__transition_list[66],,!(__GET_EXTERNAL(data__->SENSORSBT1_EX,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[66],,__GET_VAR(data__->__transition_list[66]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[66],,!(__GET_EXTERNAL(data__->SENSORSBT1_EX,)));
    }
    __SET_VAR(data__->,__transition_list[66],,0);
  }
  if (__GET_VAR(data__->STEP32.X)) {
  ...
  if (__GET_VAR(data__->STEP33.X)) {
    __SET_VAR(data__->,__transition_list[68],,!(__GET_EXTERNAL(data__->SENSORSBT2_EX,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[68],,__GET_VAR(data__->__transition_list[68]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[68],,!(__GET_EXTERNAL(data__->SENSORSBT2_EX,)));
    }
    __SET_VAR(data__->,__transition_list[68],,0);
  }
  if (__GET_VAR(data__->STEP34.X)) {
  ...
  if (__GET_VAR(data__->STEP35.X)) {
    __SET_VAR(data__->,__transition_list[70],,!(__GET_EXTERNAL(data__->SENSORSCT1_EX,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[70],,__GET_VAR(data__->__transition_list[70]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[70],,!(__GET_EXTERNAL(data__->SENSORSCT1_EX,)));
    }
    __SET_VAR(data__->,__transition_list[70],,0);
  }
  if (__GET_VAR(data__->STEP36.X)) {
  ...
  if (__GET_VAR(data__->STEP37.X)) {
    __SET_VAR(data__->,__transition_list[72],,!(__GET_EXTERNAL(data__->SENSORSCT2_EX,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[72],,__GET_VAR(data__->__transition_list[72]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[72],,!(__GET_EXTERNAL(data__->SENSORSCT2_EX,)));
    }
    __SET_VAR(data__->,__transition_list[72],,0);
  }
  if (__GET_VAR(data__->STEP38.X)) {
  ...
  if (__GET_VAR(data__->STEP40.X)) {
    __SET_VAR(data__->,__transition_list[74],,!(__GET_EXTERNAL(data__->SENSORMT1_EX,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[74],,__GET_VAR(data__->__transition_list[74]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[74],,!(__GET_EXTERNAL(data__->SENSORMT1_EX,)));
    }
    __SET_VAR(data__->,__transition_list[74],,0);
  }
  if (__GET_VAR(data__->STEP84.X)) {
  ...
  if (__GET_VAR(data__->STEP85.X)) {
    __SET_VAR(data__->,__transition_list[76],,!(__GET_EXTERNAL(data__->SENSORMT2_EX,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[76],,__GET_VAR(data__->__transition_list[76]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[76],,!(__GET_EXTERNAL(data__->SENSORMT2_EX,)));
    }
    __SET_VAR(data__->,__transition_list[76],,0);
  }
  if (__GET_VAR(data__->STEP86.X)) {
    __SET_VAR(data__->,__transition_list[77],,(__GET_EXTERNAL(data__->SENSORMT3_EX,) && !(__GET_EXTERNAL(data__->MOUNTING,))));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[77],,__GET_VAR(data__->__transition_list[77]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[77],,(__GET_EXTERNAL(data__->SENSORMT3_EX,) && !(__GET_EXTERNAL(data__->MOUNTING,))));
    }
    __SET_VAR(data__->,__transition_list[77],,0);
  }
  if (__GET_VAR(data__->STEP87.X)) {
    __SET_VAR(data__->,__transition_list[78],,!(__GET_EXTERNAL(data__->SENSORMT3_EX,)));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[78],,__GET_VAR(data__->__transition_list[78]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[78],,!(__GET_EXTERNAL(data__->SENSORMT3_EX,)));
    }
    __SET_VAR(data__->,__transition_list[78],,0);
  }
  if (__GET_VAR(data__->STEP89.X)) {
    __SET_VAR(data__->,__transition_list[79],,__GET_EXTERNAL(data__->SENSORMT4_EX,));
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[79],,__GET_VAR(data__->__transition_list[79]));
    }
  }
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[79],,__GET_EXTERNAL(data__->SENSORMT4_EX,));
    }
    __SET_VAR(data__->,__transition_list[79],,0);
  }
  if (__GET_VAR(data__->STEP44.X)) {
  ...
  if (__GET_VAR(data__->STEP83.X)) {
    __SET_VAR(data__->,__transition_list[81],,__BOOL_LITERAL(TRUE));
    if (__DEBUG) {
    ...
    if (__DEBUG) {
      __SET_VAR(data__->,__debug_transition_list[81],,__BOOL_LITERAL(TRUE));
    }
  ...
  // STEP63 action associations
  {
    ...
    if (active)       {data__->__action_list[__SFC_MOUNTING].set = 1;}
  ...
  // STEP72 action associations
  {
    char active = __GET_VAR(data__->STEP72.X);
    char activated = active && !data__->STEP72.prev_state;
    char desactivated = !active && data__->STEP72.prev_state;

    if (active)       {data__->__action_list[__SFC_MOUNTING].reset = 1;}
  ...
  if (data__->__action_list[__SFC_MOUNTING].reset) {
    __SET_EXTERNAL(data__->,MOUNTING,,0);
  }
  else if (data__->__action_list[__SFC_MOUNTING].set) {
    __SET_EXTERNAL(data__->,MOUNTING,,1);
  }
